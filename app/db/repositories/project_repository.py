"""Data access for projects, delegating to a storage backend."""
...
class ProjectRepository:
    ...
    async def get(self, project_id: str, owner: str) -> dict[str, Any] | None:
        return await self._backend.get(project_id, owner)
    ...
    async def delete(self, project_id: str, owner: str) -> bool:
        return await self._backend.delete(project_id, owner)
