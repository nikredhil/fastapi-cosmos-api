"""Data access for units (flats), delegating to a storage backend."""
...
class UnitRepository:
    ...
    async def get(self, unit_id: str, building_id: str) -> dict[str, Any] | None:
        return await self._backend.get(unit_id, building_id)
    ...
    async def delete(self, unit_id: str, building_id: str) -> bool:
        return await self._backend.delete(unit_id, building_id)
